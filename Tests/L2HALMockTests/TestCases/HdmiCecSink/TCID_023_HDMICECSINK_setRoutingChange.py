...
# Testcase ID : TCID023_setRoutingChange
...
print("TC Description - Changes routing while switching between HDMI inputs and TV. Verify the output response")
...
tc_id = 'TCID023_HdmiCecSink_setRoutingChange'
