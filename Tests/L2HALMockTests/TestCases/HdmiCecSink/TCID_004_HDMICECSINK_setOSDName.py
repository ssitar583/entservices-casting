...
set_response = Utils.send_curl_command(HdmiCecSinkApis.set_osd_name)
if set_response:
...
curl_response = Utils.send_curl_command(HdmiCecSinkApis.get_osd_name)
if curl_response:
...
tc_id = 'TCID005_HdmiCecSink_setOSDName'
